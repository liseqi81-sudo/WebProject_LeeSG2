   ...
   <form class="user" action="login.do" method="post"> <!-- ✔ action과 method 필수 -->
       <div class="form-group">
           <input type="email" class="form-control form-control-user"
                  name="id" placeholder="이메일 주소" required> <!-- ✔ name=id -->
       </div>
       <div class="form-group">
           <input type="password" class="form-control form-control-user"
                  name="pass" placeholder="비밀번호" required> <!-- ✔ name=pass -->
       </div>
       <div class="form-group">
       ...
       <button type="submit" class="btn btn-primary btn-user btn-block"> <!-- ✔ 버튼 type submit -->
           로그인
       </button>
   </form>
